...
export default function App() {
  ...
  const cardsConfig = [
    ...
    { key: 'countyFacilities', component: <LocationAnalyzerClosest featureData={countyFacilities.features} keyField="Name" featureType="County Facility" userLocationDataObj={userLocationDataObj} fields={[{key: 'Name', label: 'Facility Name' },{ key: 'Agency', label: 'Agency' }]} /> },
