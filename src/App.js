...
export default function App() {
  const [cardVisibility, setCardVisibility] = useState({
    ...
    schoolSites: { visible: true, label: 'School Sites' },
  ...
  const cardsConfig = [
    ...
    { key: 'schoolSites', component: <LocationAnalyzerClosest featureData={schoolSites.features} fields={[{ key: 'SchoolName', label: 'School Name' }]} featureType="School District" userLocationDataObj={userLocationDataObj} /> },
