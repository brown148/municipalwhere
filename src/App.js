...
export default function App() {
  ...
  const cardsConfig = [
    ...
    //{ key: 'SchoolSites', component: <LocationAnalyzer featureData={schoolSites.features} fields={[{ key: 'SchoolName', label: 'School Name' }]} featureType="School District" userLocationDataObj={userLocationDataObj} /> },
