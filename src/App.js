...
export default function App() {
  ...
  const cardsConfig = [
    ...
    { key: 'schoolSites', component: <LocationAnalyzerClosest featureData={schoolSites} fields={[{ key: 'SchoolName', label: 'School Name' }]} featureType="School District" userLocationDataObj={userLocationDataObj} /> },
