...
export default function App() {
  ...
  const cardsConfig = [
    ...
    //{ key: 'schoolSites', component: <LocationAnalyzerClosest featureData={schoolSites} fields={[{ keyField: 'SchoolName', label: 'School Name' }]} featureType="Public School" userLocationDataObj={userLocationDataObj} /> },
